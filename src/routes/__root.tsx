...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Curta a prática do tiro esportivo em um ambiente seguro. Oferecemos cursos" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Clube calibre 12" },
      { property: "og:description", content: "Curta a prática do tiro esportivo em um ambiente seguro. Oferecemos cursos" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Clube calibre 12" },
      { name: "twitter:description", content: "Curta a prática do tiro esportivo em um ambiente seguro. Oferecemos cursos" },
